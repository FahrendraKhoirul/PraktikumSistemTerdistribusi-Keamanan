...
<body>
  ...
  <fieldset>
    ...
    <?php } else { ?>
      <legend>Home</legend>
      Aplikasi Sederhana Menggunakan WSDL dengan format data XML (Extensible Markup Language). WSDL Server dan Client
      menggunakan Library NuSOAP, WSDL Client menggunakan SOAP Client
  </fieldset>
<?php } ?>
</body>
